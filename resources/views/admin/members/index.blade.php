                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                        ...
                        <form action="{{ route('admin.members.index') }}" method="GET" class="w-full md:w-1/2">
                            <div class="flex">
                                <input type="text" name="search" placeholder="Cari nama atau kode anggota..." value="{{ $search ?? '' }}" class="w-full rounded-l-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                    ...
                    <!-- PERBAIKAN: Menambahkan appends agar pencarian tetap ada saat pindah halaman -->
                    <div class="mt-6">
